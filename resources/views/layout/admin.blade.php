        ...
        <nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
            <div class="simplebar-content" style="padding: 0px;">
                ...
                <ul class="navbar-nav align-self-stretch">
                    ...
                    <li class="has-sub"><a class="nav-link collapsed text-left" href="#collapseExample2" role="button" data-toggle="collapse"><i class="flaticon-user"></i>Students</a>
                                        ...
                                        <div class="col-lg-12 px-2">
                                            <div class="submenu-box">
                                                <ul class="list-unstyled m-0">
                                                    ...
                                                    <li><a href="{{route('student.create')}}">Admission Form </a></li>
                                                    <li><a href="{{route('student.index')}}">Edit Student </a></li>
                                                    <li><a href="{{route('student.index')}}">Delete Student </a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li class="sidebar-header">TEACHER <li>
                    <li class="has-sub"><a class="nav-link collapsed text-left" href="#collapseExample3" role="button" data-toggle="collapse"><i class="flaticon-user"></i>Teachers</a>
                    ...
                    <li class="sidebar-header">PARENT <li>
                    <li class="has-sub"><a class="nav-link collapsed text-left" href="#collapseExample4" role="button" data-toggle="collapse"><i class="flaticon-user"></i>Parents</a>
                                        ...
                                        <div class="col-lg-12 px-2">
                                            <div class="submenu-box">
                                                <ul class="list-unstyled m-0">
                                                    ...
                                                    <li><a href="{{route('gaurdian.index')}}">Delete Parent </a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li class="sidebar-header">CLASS <li>
                    <li class="has-sub"><a class="nav-link collapsed text-left" href="#collapseExample5" role="button" data-toggle="collapse"><i class="flaticon-user"></i>Class</a>
                    ...
                    <li class="sidebar-header">COURSE <li>
                    <li class="has-sub"><a class="nav-link collapsed text-left" href="#collapseExample2" role="button" data-toggle="collapse"><i class="flaticon-user"></i>Courses</a>
                        <div class="collapse menu mega-dropdown" id="collapseExample2">
                            <div class="dropdown" aria-labelledby="navbarDropdown">
                                <div class="container-fluid">
                                    <div class="row">
                    ...
                    <li class="sidebar-header">ROLES <li>
                        <li class="has-sub"><a class="nav-link collapsed text-left" href="#collapseExample2" role="button" data-toggle="collapse"><i class="flaticon-user"></i>Roles</a>
                            <div class="collapse menu mega-dropdown" id="collapseExample2">
                                <div class="dropdown" aria-labelledby="navbarDropdown">
                                    <div class="container-fluid">
                                        <div class="row">
                    ...
                    <li class="sidebar-header">PERMISSIONS <li>
                        <li class="has-sub"><a class="nav-link collapsed text-left" href="#collapseExample2" role="button" data-toggle="collapse"><i class="flaticon-user"></i>Permission</a>
                            <div class="collapse menu mega-dropdown" id="collapseExample2">
                                <div class="dropdown" aria-labelledby="navbarDropdown">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-lg-12 px-2">
                                                <div class="submenu-box">
                                                    <ul class="list-unstyled m-0">
                                                        ...
                                                        <li><a href="">Add Permmission </a></li>
                                                        <li><a href="">Edit Permissions</a></li>
                                                        <li><a href="">Delete Permissions </a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="dropdown-menu dropdown-menu-right p-3">
                    <form class="form-inline mr-auto w-100 navbar-search">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" placeholder="searching for...">
                                <div class="input-group-append">
                                    <button class="btn btn-primary" type="button"><i class="fas fa-serach fa-sm"></i></button>
                                </div>
                        </div>
                    </form>
                </div>
            </li>
            <li class="nav-item dropdown"><a class="nav-link" href=""><i class="fas fa-bell fa-fw"></i>
                <span class="badge badge-danger badge-counter">3+</span>
                </a>
            </li>
            <li class="nav-item dropdown"><a class="nav-link" href=""><i class="fas fa-bell fa-envelope"></i>
