            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-6 col-lg-6 col-12 form-group justify-content-center">
                    ...
                    <select class="form-control @error('class_room_id') is-invalid @enderror" id="sel2" name="class_room_id" required>
                        <option selected value="{{$course->classRoom->id}}">{{$course->classRoom->name}}</option>
                ...
                <div class="col-xl-6 col-lg-6 col-12 form-group justify-content-center">
                    ...
                    <select class="form-control @error('teacher_id') is-invalid @enderror" id="sel2" name="teacher_id" required>
                        <option selected value="{{$course->teacher->id}}">{{$course->teacher->user->first_name}} {{$course->teacher->user->last_name}}</option>
                ...
                <div class="col-xl-6 col-lg-6 col-12 form-group justify-content-center">
                    ...
                    <select class="form-control @error('role') is-invalid @enderror" id="sel2" name="semester_id" required>
                        <option selected value="1" >{{$course->semester->name}}</option>
